...
-- 1. Retrieve all books in 'Fictional' genre:
...
-- 7. Show customers who orderd more than 1 quantity of a books:
...
-- 11. Find the books with lowest stock:
...
SELECT o.Book_id, b.title, COUNT(orders_id) AS ORDER_COUNT
FROM orders o 
JOIN books b ON  o.book_id = b.book_id
